<div class="col-md-3 left_col menu_fixed">
	<div class="left_col scroll-view">
		...
		<div class="profile">
			...
			<%-- 	<img src="<%=request.getContextPath()%>/Images/Users/Satya_pic.jpg" 
						alt="Satyakam Mohapatra" class="img-circle profile_img"> --%>
			</div>
				...
				<ul class="nav side-menu">
					...
					<li><a><i class="fa fa-desktop"></i> Accounts <span class="fa fa-chevron-down"></span></a>
						<ul class="nav child_menu">
							...
							<li><a href="accountsnew">Create New</a></li>
							<li><a href="accountsviewall">View All</a></li>
						</ul>
					</li>
					
					<li><a><i class="fa fa-edit"></i> Transactions <span class="fa fa-chevron-down"></span></a>
						<ul class="nav child_menu">
							<li><a href="transactionsnew">Create New</a></li>
							<li><a href="transactionsViewAll">View All</a></li>
						</ul>
					</li>
